...
// ================== NOVO: Schema das Mensagens ==================
const MessageSchema = new mongoose.Schema({
  timestamp: { type: Date, default: Date.now },
  nome: String,
  message: String
});
// 'Message' vira a coleção 'messages' no MongoDB
...
app.post('/api', async (req, res) => {
  ...
  try {
    ...
    // ================== NOVO: Endpoint para POSTAR mensagem ==================
...
// ================== NOVO: Endpoint para BUSCAR mensagens (Público) ==================
...
app.post('/admin-api', async (req, res) => {
  ...
  try {
    ...
    // ================== NOVO: Endpoint do Admin para BUSCAR mensagens ==================
...
// ================== NOVO: Handler para POSTAR mensagem ==================
async function handlePostMessage(req, res) {
  ...
  if (message.length > 500) { // Um limite profissional
  ...
  await newMessage.save(); // Salva no MongoDB

  // Retorna a mensagem criada (para o front-end a poder adicionar ao feed)
