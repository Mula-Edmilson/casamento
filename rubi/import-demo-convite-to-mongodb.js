/*
  Importador MongoDB — Amara & Daniel
  ...
  node import-lirandzo-demo-convite-to-mongodb.js
*/
...
const SLUG = process.env.INVITE_SLUG || 'lirandzo-demo-convite';
...
async function main() {
  ...
  const invite = await Invite.findOneAndUpdate(
    { slug: SLUG },
    {
      $set: {
        slug: SLUG,
        clientName: event.displayNames || event.coupleNames || 'Amara & Daniel',
        coupleNames: event.coupleNames || 'Amara & Daniel',
        bride: event.bride || 'Amara Silva',
        groom: event.groom || 'Daniel Costa',
