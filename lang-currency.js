(function () {
  ...
  const translations = {
    ...
    'Agenda com mapa, contagem regressiva, música, retratos dos noivos e feed de felicitações reunidos numa apresentação elegante e fácil de partilhar.': 'Schedule with map, countdown, music, couple portraits and congratulations feed brought together in an elegant, easy-to-share presentation.',
    ...
    'Retratos dos Noivos': 'Couple Portraits',
    'Lembrete automático da data do evento': 'Automatic event date reminder',
    'Presentes de Casamento': 'Wedding Gifts',
    'Sessão Pré-Wedding (Fotos)': 'Pre-Wedding Session (Photos)',
    'Sessão Pré-Wedding (Fotos + 1 Vídeo)': 'Pre-Wedding Session (Photos + 1 Video)',
