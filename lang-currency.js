(function () {
  ...
  Object.assign(translations, {
    ...
    '© 2026 Lirandzo. Todos os direitos reservados. Feito por': '© 2026 Lirandzo. All rights reserved. Made by',
    '© 2026 Lirandzo. Todos os direitos reservados. Feito por ': '© 2026 Lirandzo. All rights reserved. Made by ',
    'Feito por': 'Made by',
  ...
  // LIRANDZO_FORM_PAGE_TRANSLATIONS — package-based client briefing form
  Object.assign(translations, {
    "Formulário": "Form",
    "Convites Digitais": "Digital Invitations",
    "♡ Apoio no WhatsApp": "♡ WhatsApp support",
    "Formulário de produção · Lirandzo": "Production form · Lirandzo",
    "Dados para criar o seu convite": "Details to create your invitation",
    "Escolha o pacote pretendido e preencha apenas os dados necessários para esse convite. O formulário adapta-se ao pacote escolhido para evitar campos longos, repetidos ou desnecessários.": "Choose the package you want and fill in only the details needed for that invitation. The form adapts to the selected package to avoid long, repeated or unnecessary fields.",
    "Antes de começar": "Before you start",
    "Tenha consigo os nomes completos, datas, locais, links dos mapas, contactos de apoio e links das fotografias que pretende usar no convite.": "Have the full names, dates, venues, map links, support contacts and photo links you want to use in the invitation ready.",
    "Campos com asterisco são obrigatórios.": "Fields with an asterisk are required.",
    "Pode deixar indicações em aberto quando ainda não tiver tudo fechado.": "You can leave notes open when everything is not yet final.",
    "Fotografias devem ser enviadas por link do Drive, Dropbox ou WeTransfer.": "Photos should be sent via a Drive, Dropbox or WeTransfer link.",
    "Primeiro escolha o pacote. Depois, o formulário mostra apenas os campos realmente necessários para esse nível de convite.": "First choose the package. Then the form shows only the fields truly needed for that invitation level.",
    "0% preenchido": "0% completed",
    "Escolha o pacote": "Choose the package",
    "Ao seleccionar o pacote, aparecem apenas os blocos de informação necessários para produzir aquele convite. Isto reduz o tempo de preenchimento e evita perguntas que não se aplicam.": "When you select the package, only the information blocks needed to produce that invitation appear. This reduces completion time and avoids questions that do not apply.",
    "Nenhum pacote escolhido": "No package selected",
    "Essencial": "Essential",
    "Pérola": "Pearl",
    "Convite elegante e directo com a informação principal do evento.": "An elegant, direct invitation with the main event information.",
    "Capa com foto e nomes": "Cover with photo and names",
    "Agenda com mapa": "Schedule with map",
    "Feed de felicitações": "Congratulations feed",
    "Contagem regressiva e música": "Countdown and music",
    "Mais escolhido": "Most chosen",
    "Esmeralda": "Emerald",
    "Mais organização, memória visual e recursos úteis para os convidados.": "More organisation, visual memories and useful resources for guests.",
    "Tudo do Pérola": "Everything in Pearl",
    "Presentes e dress code": "Gifts and dress code",
    "Pré-wedding com 5 fotos": "Pre-wedding with 5 photos",
    "Dashboard de convidados": "Guest dashboard",
    "Rubi": "Ruby",
    "Experiência mais completa com vídeo, check-in e recursos premium.": "A more complete experience with video, check-in and premium resources.",
    "Tudo do Esmeralda": "Everything in Emerald",
    "7 fotos + 1 vídeo": "7 photos + 1 video",
    "Check-in com código de entrada": "Check-in with entry code",
    "Cápsula por 30 dias": "Capsule for 30 days",
    "Escolha um pacote para ver o formulário correspondente.": "Choose a package to see the corresponding form.",
    "Contacto do cliente": "Client contact",
    "Informação para contacto, confirmação e acompanhamento.": "Information for contact, confirmation and follow-up.",
    "Nome do cliente": "Client name",
    "Contacto / WhatsApp": "Contact / WhatsApp",
    "Cidade / País": "City / Country",
    "Data desejada para entrega": "Desired delivery date",
    "Quem aprova o convite?": "Who approves the invitation?",
    "Tipo de convite e modelo": "Invitation type and template",
    "Preferências iniciais de estilo, idioma e estrutura.": "Initial style, language and structure preferences.",
    ...
    "Baptizado": "Baptism",
    "Evento familiar": "Family event",
    "Outro evento": "Other event",
    "Modelo escolhido": "Selected template",
    "Idioma do convite": "Invitation language",
    "Português e Inglês": "Portuguese and English",
    "Inglês": "English",
    "Outro idioma": "Other language",
    "Estilo visual pretendido": "Desired visual style",
    "Elegante e romântico": "Elegant and romantic",
    "Minimalista": "Minimalist",
    "Clássico": "Classic",
    "Moderno": "Modern",
    "Luxo discreto": "Discreet luxury",
    "Tradicional": "Traditional",
    "Ainda não sei": "I am not sure yet",
    "Cores principais": "Main colours",
    "Música / ambiente sonoro": "Music / sound mood",
    "Nota: se ainda não tiver escolhido um modelo, escreva “ainda não escolhi” e indique o estilo que mais gosta.": "Note: if you have not chosen a template yet, write “I have not chosen yet” and indicate the style you like most.",
    "Dados dos noivos ou anfitriões": "Couple or host details",
    "Nomes principais, familiares e frase de destaque.": "Main names, family details and highlight phrase.",
    "Nome da noiva / anfitriã": "Bride / hostess name",
    "Nome do noivo / anfitrião": "Groom / host name",
    "Nomes como devem aparecer no convite": "Names as they should appear on the invitation",
    "Pais da noiva / anfitriã": "Bride / hostess parents",
    "Pais do noivo / anfitrião": "Groom / host parents",
    "Iniciais / monograma": "Initials / monogram",
    "Versículo, frase ou citação": "Verse, phrase or quote",
    "Data, programa e locais": "Date, schedule and venues",
    "Informações do grande dia, horários e mapas.": "Big-day information, times and maps.",
    "Data do evento": "Event date",
    "Hora principal": "Main time",
    "Prazo de RSVP": "RSVP deadline",
    "Fuso horário": "Time zone",
    "Cerimónia — nome/local": "Ceremony — name/venue",
    "Hora": "Time",
    "Link do mapa da cerimónia": "Ceremony map link",
    "Recepção — nome/local": "Reception — name/venue",
    "Link do mapa da recepção": "Reception map link",
    "Programa adicional": "Additional schedule",
    "História, carta e mensagens": "Story, letter and messages",
    "Conteúdo emocional que dá vida ao convite.": "Emotional content that brings the invitation to life.",
    "A nossa história — o encontro": "Our story — the meeting",
    "A nossa história — amizade / início": "Our story — friendship / beginning",
    "A nossa história — crescimento": "Our story — growth",
    "A nossa história — promessa": "Our story — promise",
    "Carta dos noivos / anfitriões": "Couple / hosts letter",
    "Padrinhos, honra e homenagens": "Godparents, honour and tributes",
    "Pessoas especiais, funções e dedicatórias.": "Special people, roles and dedications.",
    "Padrinhos, madrinhas, damas e cavalheiros": "Godparents, bridesmaids and groomsmen",
    "Homenagem às famílias": "Family tribute",
    "Outras pessoas ou homenagens especiais": "Other people or special tributes",
    "RSVP, convidados e entrada": "RSVP, guests and entry",
    "Confirmação de presença, mesas e controlo de acesso.": "Attendance confirmation, tables and access control.",
    "O convite terá RSVP?": "Will the invitation include RSVP?",
    "Sim": "Yes",
    "Não": "No",
    "Número estimado de convidados": "Estimated number of guests",
    "Link da lista de convidados": "Guest list link",
    "Mesas ou lugares definidos?": "Are tables or seats defined?",
    "Ainda não": "Not yet",
    "Sim, por mesa": "Yes, by table",
    "Sim, por lugar": "Yes, by seat",
    "Não será necessário": "Not needed",
    "Código de entrada / QR code": "Entry code / QR code",
    "Sim, quero usar": "Yes, I want to use it",
    "Contactos de apoio no dia": "Support contacts for the day",
    "Perguntas extra no RSVP": "Extra RSVP questions",
    "Presentes e contribuições": "Gifts and contributions",
    "Lista de presentes, conta bancária e métodos de contribuição.": "Gift list, bank account and contribution methods.",
    "Secção de presentes": "Gifts section",
    "Lista de presentes + contribuição monetária": "Gift list + monetary contribution",
    "Apenas lista de presentes": "Gift list only",
    "Apenas contribuição monetária": "Monetary contribution only",
    "Não incluir": "Do not include",
    "Banco / titular": "Bank / account holder",
    "NIB / IBAN / NUIB": "NIB / IBAN / NUIB",
    "M-Pesa / e-Mola / outro": "M-Pesa / e-Mola / other",
    "Links dos logos dos métodos de pagamento": "Payment method logo links",
    "Lista de presentes": "Gift list",
    "Menu, etiqueta e apoio": "Menu, etiquette and support",
    "Informações úteis para orientar os convidados.": "Useful information to guide guests.",
    "Menu da celebração": "Celebration menu",
    "Dress code / inspiração de vestuário": "Dress code / outfit inspiration",
    "Etiqueta do evento": "Event etiquette",
    "Transporte, estacionamento e chegada": "Transport, parking and arrival",
    "Observações finais": "Final notes",
    "Indicações adicionais, restrições e prioridades.": "Additional notes, restrictions and priorities.",
    "Observações gerais": "General notes",
    "Prioridades do cliente": "Client priorities",
    "Entrega rápida": "Fast delivery",
    "Design mais romântico": "More romantic design",
    "Design mais minimalista": "More minimalist design",
    "Mais impacto visual": "More visual impact",
    "Apoio nos textos": "Text support",
    "Ainda preciso de orientação": "I still need guidance",
    "Confirmo que li e aceito os": "I confirm that I have read and accept the",
    "e a": "and the",
    "da Lirandzo.": "of Lirandzo. I also confirm that the submitted information may be used exclusively to produce and personalise the digital invitation.",
    "Enviar formulário": "Send form",
    "Convites digitais elegantes para casamentos e eventos memoráveis.": "Elegant digital invitations for weddings and memorable events.",
    "Experiências digitais elegantes para casamentos, convites para eventos e momentos especiais.": "Elegant digital experiences for weddings, event invitations and special moments.",
    "Convites para eventos": "Event invitations",
    ...
    "© 2026 Lirandzo. Todos os direitos reservados. Feito por ": "© 2026 Lirandzo. All rights reserved. Made by ",
    "Feito por": "Made by",
    "Formulário de adesão ao convite digital": "Digital invitation onboarding form",
    "Escolha do pacote Lirandzo": "Lirandzo package choice",
    "Confirmação dos termos e envio": "Terms confirmation and submission",
    "Orientações antes de preencher": "Guidance before filling in",
    "Rodapé Lirandzo": "Lirandzo footer",
    "Ligar para Lirandzo": "Call Lirandzo"
});
  ...
  Object.assign(placeholders, {
    "Ex.: Edmilson Mula": "E.g.: Edmilson Mula",
    "Ex.: +258 87 000 0000": "E.g.: +258 87 000 0000",
    "email@exemplo.com": "email@example.com",
    "Ex.: Maputo, Moçambique": "E.g.: Maputo, Mozambique",
    "Ex.: Noiva, noivo, cerimonialista": "E.g.: bride, groom, wedding planner",
    "Ex.: modelo Ana & Miguel / link do modelo": "E.g.: Ana & Miguel template / template link",
    "Ex.: tons terra, branco, dourado": "E.g.: earth tones, white, gold",
    "Nome da música, link ou estilo": "Song name, link or style",
    "Ex.: Ana & Miguel": "E.g.: Ana & Miguel",
    "Ex.: Filha de ... e de ...": "E.g.: Daughter of ... and ...",
    "Ex.: Filho de ... e de ...": "E.g.: Son of ... and ...",
    "Ex.: AM": "E.g.: AM",
    "Texto que aparece na abertura do convite": "Text that appears at the opening of the invitation",
    "Ex.: Africa/Maputo": "E.g.: Africa/Maputo",
    "Ex.: Igreja / Capela": "E.g.: Church / Chapel",
    "https://maps.google.com/...": "https://maps.google.com/...",
    "Ex.: Quinta / Salão": "E.g.: Venue / Hall",
    "Ex.: civil, copo de água, sessão de fotos, festa, horários e observações.": "E.g.: civil ceremony, cocktail, photo session, party, times and notes.",
    "Como se conheceram?": "How did you meet?",
    "Como a relação começou a crescer?": "How did the relationship begin to grow?",
    "Momentos importantes, desafios ou aprendizagens.": "Important moments, challenges or lessons.",
    "Mensagem final sobre o compromisso.": "Final message about the commitment.",
    "Mensagem de gratidão aos convidados.": "Thank-you message for the guests.",
    "Escreva: Nome | função | pequena dedicatória. Um por linha.": "Write: Name | role | short dedication. One per line.",
    "Mensagem de homenagem, agradecimento ou texto especial.": "Tribute, thank-you message or special text.",
    "Ex.: pais ausentes, avós, equipa de honra, familiares importantes.": "E.g.: absent parents, grandparents, honour team, important relatives.",
    "Ex.: 150": "E.g.: 150",
    "Google Sheets / Excel online": "Google Sheets / online Excel",
    "Ex.: +258 84..., +258 87...": "E.g.: +258 84..., +258 87...",
    "Ex.: restrições alimentares, número de acompanhantes, transporte, presença na cerimónia e recepção.": "E.g.: dietary restrictions, number of companions, transport, attendance at ceremony and reception.",
    "Ex.: Millennium BIM — Titular": "E.g.: Millennium BIM — Account holder",
    "NIB, IBAN ou NUIB": "NIB, IBAN or NUIB",
    "Número, titular e serviço": "Number, account holder and service",
    "Pasta com logos ou imagens": "Folder with logos or images",
    "Escreva: presente | descrição | observação. Um por linha.": "Write: gift | description | note. One per line.",
    "Entrada, prato principal, bebidas, sobremesa e restrições alimentares.": "Starter, main course, drinks, dessert and dietary restrictions.",
    "Ex.: casual elegante, tons neutros, branco, preto, dourado.": "E.g.: elegant casual, neutral tones, white, black, gold.",
    "Ex.: pontualidade, telemóvel em silêncio, fotos com discrição.": "E.g.: punctuality, phones on silent, discreet photos.",
    "Indicações para chegar, estacionamento, shuttle, rotas e apoio.": "Directions, parking, shuttle, routes and support.",
    "Tudo que a Lirandzo deve considerar antes de produzir o convite.": "Everything Lirandzo should consider before producing the invitation."
});
