...
const SLUG = process.env.INVITE_SLUG || 'flicia-walter-convite';
...
async function main() {
  ...
  const invite = await Invite.findOneAndUpdate(
    { slug: SLUG },
    {
      $set: {
        slug: SLUG,
        clientName: event.displayNames || event.coupleNames || 'Flícia & Walter',
        coupleNames: event.coupleNames || 'Flícia & Walter',
        bride: event.bride || 'Flícia Alberto Chambal',
        groom: event.groom || 'Walter Ivan Francisco Mafumo',
