Calate & Helder — Convite migrado para Render + MongoDB
...
- import-calate-helder-to-mongodb.js: importador directo para MongoDB
- guests-import-adminmanager.txt: lista pronta para colar/importar no AdminManager

URL final esperada:
https://lirandzo.com/convite/calate-helder/

Dados integrados:
- Noivos: Calate Salazar Hojuane & Hélder Jorge Muianga
