(() => {
  ...
  const slug = window.LIRANDZO_INVITE_SLUG || eventData.slug || 'binigna-leonel';
  ...
  function renderBase(){
    document.querySelectorAll('[data-field="coupleNames"]').forEach(el => el.textContent = eventData.coupleNames || 'Binigna & Leonel');
