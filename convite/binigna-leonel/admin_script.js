    ...
    (function () {
      ...
      function fillEventDetails() {
        $('topbarSubtitle').textContent = `${EVENT.displayNames || EVENT.coupleNames || 'Binigna & Leonel'} · ${EVENT.eventDateLong || 'Data do evento'}`;
        $('eventChip').textContent = EVENT.eventDateLong || onlyDate(EVENT.dateISO);
        $('eventName').textContent = `${EVENT.eventType || 'Casamento'} · ${EVENT.displayNames || EVENT.coupleNames || 'Binigna & Leonel'}`;
