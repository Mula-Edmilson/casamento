/*
  Importador MongoDB — Rosalina & Monteiro
  ...
  node import-rosalina-monteiro-to-mongodb.js
*/
...
async function main() {
  ...
  const invite = await Invite.findOneAndUpdate(
    { slug: SLUG },
    {
      $set: {
        slug: SLUG,
        clientName: event.displayNames || event.coupleNames || 'Rosalina & Monteiro',
        coupleNames: event.coupleNames || 'Rosalina & Monteiro',
        bride: event.bride || 'Rosalina Ezequiel',
        groom: event.groom || 'Monteiro Francisco',
