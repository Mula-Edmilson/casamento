...
function applyTemplateReplacements(content, ctx, filePath = '') {
  ...
  const replacements = {
    louren-acacio: ctx.slug, https://api-casamento-mj.onrender.com: ctx.apiBaseUrl, https://api-casamento-mj.onrender.com/api: `${ctx.apiBaseUrl}/api`,
    Louren & Acácio: ctx.coupleNames, Acácio: ctx.clientName, Louren: ctx.bride || '',
    Acácio: ctx.groom || '', esmeralda: ctx.packageKey, https://lirandzo.com/convite/louren-acacio/: ctx.publicUrl
  };
