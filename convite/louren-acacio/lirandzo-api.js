(() => {
  ...
  const slug = window.LIRANDZO_INVITE_SLUG || eventData.slug || 'louren-acacio';
  ...
  function renderBase(){
    document.querySelectorAll('[data-field="coupleNames"]').forEach(el => el.textContent = eventData.coupleNames || 'Louren & Acácio');
