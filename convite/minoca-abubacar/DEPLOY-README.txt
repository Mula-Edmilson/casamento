Deploy rápido — Minoca & Abubacar

1. Enviar a pasta /minoca-abubacar/ para o caminho público:
   /convite/minoca-abubacar/

2. Confirmar no client-config.js:
   window.LIRANDZO_INVITE_SLUG = 'minoca-abubacar';
...
5. Testar:
   /convite/minoca-abubacar/index.html
...
- assets/media/minoca-abubacar-hero.jpg: fotografia aplicada no hero do convite.
- assets/media/minoca-abubacar-save-the-date.jpg: fotografia aplicada na capa/index do convite.
- assets/media/minoca-abubacar-brinde.jpg, minoca-abubacar-pedido.jpg, minoca-abubacar-comemoracao.jpg e minoca-abubacar-pose-2.jpg: fotografias integradas nas secções internas e galeria.
...
- import-minoca-abubacar-to-mongodb.js também remove presentes antigos que não constam na lista oficial.
...
- as acções administrativas continuam a passar por `/admin-api` com `slug: minoca-abubacar`.
