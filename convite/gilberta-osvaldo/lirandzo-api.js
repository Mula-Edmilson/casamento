(() => {
  ...
  const slug = window.LIRANDZO_INVITE_SLUG || eventData.slug || 'gilberta-osvaldo';
  ...
  function renderBase(){
    document.querySelectorAll('[data-field="coupleNames"]').forEach(el => el.textContent = eventData.coupleNames || 'Gilberta & Osvaldo');
