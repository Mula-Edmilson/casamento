(() => {
  ...
  const slug = window.LIRANDZO_INVITE_SLUG || eventData.slug || 'juliana-baptista';
  ...
  function renderBase(){
    document.querySelectorAll('[data-field="coupleNames"]').forEach(el => el.textContent = eventData.coupleNames || 'Juliana & Baptista');
