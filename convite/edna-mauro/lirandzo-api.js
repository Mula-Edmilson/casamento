(() => {
  ...
  const slug = window.LIRANDZO_INVITE_SLUG || eventData.slug || 'edna-mauro';
  ...
  function renderBase(){
    document.querySelectorAll('[data-field="coupleNames"]').forEach(el => el.textContent = eventData.coupleNames || 'Edna & Mauro');
