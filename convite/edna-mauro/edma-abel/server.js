...
function applyTemplateReplacements(content, ctx, filePath = '') {
  ...
  const replacements = {
    edna-mauro: ctx.slug, https://api-casamento-mj.onrender.com: ctx.apiBaseUrl, https://api-casamento-mj.onrender.com/api: `${ctx.apiBaseUrl}/api`,
    Edna & Mauro: ctx.coupleNames, Edna Mondlane: ctx.clientName, Edna: ctx.bride || '',
    Mauro: ctx.groom || '', esmeralda: ctx.packageKey, https://lirandzo.com/convite/edna-mauro/: ctx.publicUrl
  };
