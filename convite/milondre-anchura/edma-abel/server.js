...
function applyTemplateReplacements(content, ctx, filePath = '') {
  ...
  const replacements = {
    milondre-anchura: ctx.slug, https://api-casamento-mj.onrender.com: ctx.apiBaseUrl, https://api-casamento-mj.onrender.com/api: `${ctx.apiBaseUrl}/api`,
    Milondre & Anchura: ctx.coupleNames, Edna Mondlane: ctx.clientName, Edna: ctx.bride || '',
    Mauro: ctx.groom || '', esmeralda: ctx.packageKey, https://lirandzo.com/convite/milondre-anchura/: ctx.publicUrl
  };
