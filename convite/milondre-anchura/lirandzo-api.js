(() => {
  ...
  const slug = window.LIRANDZO_INVITE_SLUG || eventData.slug || 'milondre-anchura';
  ...
  function renderBase(){
    document.querySelectorAll('[data-field="coupleNames"]').forEach(el => el.textContent = eventData.coupleNames || 'Milondre & Anchura');
    ...
    document.body.dataset.package = eventData.packageKey || 'esmeralda';
