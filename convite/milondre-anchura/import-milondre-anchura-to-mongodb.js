/*
  Importador MongoDB — Milondre & Anchura
  ...
  node import-milondre-anchura-to-mongodb.js
*/
...
const SLUG = process.env.INVITE_SLUG || 'milondre-anchura';
  ...
  const invite = await Invite.findOneAndUpdate(
    { slug: SLUG },
    {
      $set: {
        ...
        coupleNames: event.coupleNames || 'Milondre & Anchura',
